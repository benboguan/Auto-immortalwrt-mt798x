...
rm -rf feeds/small/{luci-app-homeproxy,luci-app-momo,luci-app-fchomo,luci-app-bypass,luci-app-ssr-plus,luci-app-nikki,luci-app-passwall2,luci-app-clashoo,momo,mihomo,nikki,clashoo}
rm -rf feeds/feeds_app/{luci-theme-alpha,luci-app-alist,luci-app-smartdns,smartdns}
