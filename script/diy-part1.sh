...
rm -rf feeds/small/{luci-app-homeproxy,luci-app-momo,luci-app-fchomo,luci-app-bypass,luci-app-ssr-plus,luci-app-nikki,luci-app-passwall2,momo,mihomo,nikki,clashoo}
