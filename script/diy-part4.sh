...
# 修改主机名字，把R128修改你喜欢的就行（不能纯数字或者使用中文）
sed -i 's/ImmortalWrt/R128/g' package/base-files/files/bin/config_generate

# 修改开源驱动wifi名称
#sed -i 's/OpenWrt/R128_AX3000/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
