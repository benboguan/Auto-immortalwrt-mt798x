...
sed -i 's/$hostname-2.4G/R30B1_2.4G/g' package/mtk/drivers/wifi-profile/files/mt7981/files/common/lib/wifi/mtk.sh
...
sed -i 's/$hostname-5G/R30B1_5G/g' package/mtk/drivers/wifi-profile/files/common/mt7981/files/lib/wifi/mtk.sh
