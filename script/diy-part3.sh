...
sed -i 's/OpenWRT-2.4G/MSG1500/g' package/lean/mt/drivers/mt7615d/files/lib/wifi/mt_dbdc.sh
...
sed -i 's/OpenWRT-5G/MSG1500-5G/g' package/lean/mt/drivers/mt7615d/files/lib/wifi/mt_dbdc.sh

# 修改内核版本为5.10
sed -i 's/5.4/5.10/g' target/linux/ramips/Makefile

# 添加个性信息
#sed -i 's/R22.7.7/mode by nanchuci R22.7.7/g' package/lean/default-settings/files/zzz-default-settings
