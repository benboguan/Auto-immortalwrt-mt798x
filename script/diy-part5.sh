...
sed -i 's/$hostname-2.4G/MSG1500_2.4G/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mt_dbdc.sh
...
sed -i 's/$hostname-5G/MSG1500_5G/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mt_dbdc.sh
