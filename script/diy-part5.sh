...
sed -i 's/$hostname-2.4G/MSG1500_2.4G/g' package/mtk/drivers/mt7615d/files/lib/wifi/mtk.sh
...
sed -i 's/$hostname-5G/MSG1500_5G/g' package/mtk/drivers/mt7615d/files/lib/wifi/mtk.sh
